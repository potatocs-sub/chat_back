...
주어진 대화 내용과 질문을 바탕으로 현재 질문의 문장을 일부 수정하여 새로운 질문을 만들어 주세요.
대화 기록은 시간 순서대로 정렬되어 있으며, 현재 질문과 관련이 있을 수 있습니다.

다음 규칙을 반드시 준수하세요:
1. 애매한 표현은 과거 대화 내용을 참고하여 구체적으로 수정하세요.
2. 이전 대화와 관련이 없다고 판단되면 현재 질문만을 사용하여 재구성하세요.
3. 질문에 대한 답변이나 정보를 제공하지 마세요.
4. 이전 대화와 관련이 있다고 판단할 경우, 현재 질문을 통해 이전 대화를 이해할 수 있도록 관련 단어를 반드시 포함하세요.
